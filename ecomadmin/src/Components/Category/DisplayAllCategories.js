...
import {getData,postData,postDataAndImage,ServerURL} from '../FetchServices';
...
export default function DisplayAllCategories(){
  ...
  const [getColumn, setColumn]=useState({
    columns: [
      ...
      {title:  'Icon',  render: rowData => <div><Avatar variant='rounded' src={`${ServerURL}/images/${rowData.icon}`} /></div>},
      {title:  'Ad Image',  render: rowData => <div><Avatar variant='rounded' src={`${ServerURL}/images/${rowData.ad}`} /></div>},
...
const handleEditData=async()=>{
  ...
  var result=await postDataAndImage('category/editDataImage',formData,config)
  ...
  const editDialog=()=>{
    ...
    return (
          ...
          >
            <DialogTitle id="alert-dialog-title">{"Update Categories"}</DialogTitle>
            <DialogContent>
                  ...
                  <Grid contianer spacing={2}> 
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={12} md={12} lg={12}> 
                          ...
                          <TextField label="Category Name" className={classes.text1} value={getCotegoryName} onChange={(event)=>{setCotegoryName(event.target.value)}}/>  
                        </Grid>
                           
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                        <img src={getErrorDes} width='12' height='12' className={classes.valImg} />
                          <TextField label="Description" className={classes.text2} value={getDescription}  onChange={(event)=>{setDescription(event.target.value)}}/>
                        </Grid> 
                        ...
                        <label htmlFor="contained-button-file">
                          ...
                          <Avatar alt="Remy Sharp" variant='rounded' className={classes.updateIcon} style={{width:70,height:50}} src={getIcon.icon} />
                          </Grid>
                        ...
                        <Grid item xs={6} className={classes.container}>
                        <Avatar alt="Remy Sharp" variant='rounded' className={classes.updatead} style={{width:70,height:55}} src={getAd.icon} />
                        </Grid>
                      </Grid>   
                      ...
                      <div style={{fontWeight:'bold',marginLeft:30}}> Ad Status: </div>
                        <div>
                          <Radio
                    ...
                    <Grid item xs={12}  className={classes.container}>
                       ...
                       <Button variant="contained"  color="primary" onClick={handleEditData}>Edit Above Data</Button>
                    </Grid>
                    <Grid item xs={6}>
